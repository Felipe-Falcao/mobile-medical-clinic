...
class SearchableDropdown<T> extends StatefulWidget {
  final List<DropdownMenuItemDiff<T>> items;
  ...
  factory SearchableDropdown.single({
    Key key,
    @required List<DropdownMenuItemDiff<T>> items,
      ...
      child: Scrollbar(
        child: new ListView.builder(
          itemBuilder: (context, index) {
            DropdownMenuItemDiff item = widget.items[shownIndexes[index]];
            return Container(
              height: 40,
...
class _DropdownMenuItemDiffContainer extends StatelessWidget {
  const _DropdownMenuItemDiffContainer({
    Key key,
    @required this.child,
  })  : assert(child != null),
        super(key: key);
...
@override
class DropdownMenuItemDiff<T> extends _DropdownMenuItemDiffContainer {
  const DropdownMenuItemDiff({
    Key key,
    this.onTap,
    this.value,
